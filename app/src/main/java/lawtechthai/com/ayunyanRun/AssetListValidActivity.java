...
public class AssetListValidActivity extends AppCompatActivity {
    private static final String HI = "https://www.lawtechthai.com/Assets/assetListValidShow.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_asset_list_expired);

            rv = (RecyclerView) findViewById(R.id.assetListExpired_recyclerview);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.assetListMenu_clearButton) {
            ...
            startActivity(i);
            return true;
        } else if (item.getItemId() == R.id.assetListMenu_showAllButton) {
    ...
    protected void sendEmail() {
        ...
        Uri data = Uri.parse("mailto:?subject=" + "Asset List" + "&body=" + "Visit: https://www.lawtechthai.com/Assets/assetListShow.php" + "&to=" + "email@gmail.com");
