...
public class AssetListExpiredActivity extends AppCompatActivity {
    private static final String HI = "https://www.lawtechthai.com/Assets/assetListExpiredShow.php";
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.assetListMenu_clearButton) {
            ...
            i.putExtra("url", "https://www.lawtechthai.com/Assets/assetListExpiredShow.php");
            startActivity(i);
            return true;
